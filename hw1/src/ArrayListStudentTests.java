...
public class ArrayListStudentTests {
    ...
    public void testAddStringsFront() {
        ...
        list.addToFront("5a"); // 4a 3a 2a 1a 0a
        list.addToFront("6a"); // 4a 3a 2a 1a 0a
        list.addToFront("7a"); // 4a 3a 2a 1a 0a
        list.addToFront("8a"); // 4a 3a 2a 1a 0a
        list.addToFront("9a"); // 4a 3a 2a 1a 0a
        list.addToFront("10a"); // 4a 3a 2a 1a 0a
        ...
        expected[10] = "0a"; // 0a
        expected[9] = "1a"; // 1a 0a
        expected[8] = "2a"; // 2a 1a 0a
        expected[7] = "3a"; // 3a 2a 1a 0a
        expected[6] = "4a"; // 4a 3a 2a 1a 0a
        expected[5] = "5a"; // 4a 3a 2a 1a 0a
        expected[4] = "6a"; // 4a 3a 2a 1a 0a
        expected[3] = "7a"; // 4a 3a 2a 1a 0a
        expected[2] = "8a"; // 4a 3a 2a 1a 0a
        expected[1] = "9a"; // 4a 3a 2a 1a 0a
        expected[0] = "10a"; // 4a 3a 2a 1a 0a
